...
//UO: changed so that new load call cancels previous ajax call
...
$.extend(SVGWrapper.prototype, {
	...
	load: function(url, settings) {
		...
		if (url.match('<svg')) { // Inline SVG
			...
			//UO: check for and cancel previous ajax call
			if (ajaxCall)
				ajaxCall.abort();
			ajaxCall = $.ajax({url: url, dataType: ($.browser.msie ? 'text' : 'xml'),
